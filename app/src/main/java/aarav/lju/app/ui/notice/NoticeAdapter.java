...
import aarav.lju.app.FullImageView;
import aarav.lju.app.R;

public class NoticeAdapter extends RecyclerView.Adapter<NoticeAdapter.NoticeViewAdapter> {

    private Context context;
    private ArrayList<aarav.lju.app.ui.notice.NoticeData> list;

    public NoticeAdapter(Context context, ArrayList<aarav.lju.app.ui.notice.NoticeData> list) {
    ...
    public void onBindViewHolder(@NonNull NoticeViewAdapter holder, @SuppressLint("RecyclerView") int position) {
        ...
        aarav.lju.app.ui.notice.NoticeData currentItem = list.get(position);
